		...
		gridOptions.api.forEachNode(function(rowNode, index) {
					...
					success : function(data) {
						...
						$.each(data.monthAttdMgtList, function(i, elt){
							...
							console.log("111"); console.log((typeof data.monthAttdMgtList));
							console.log("222"); console.log((typeof data));
							
							console.log("333"); console.log(data.monthAttdMgtList);
							console.log("444"); console.log(data);
							
							console.log("555"); console.log(i);
							console.log("666"); console.log(elt);
